/**************************************************************************/
/*!
    @file     TCS34725_quickswitch.cpp
    @author   KTOWN (Adafruit Industries)
			  adapted by RENS DOORNBUSCH
    @license  BSD (see license.txt)

    Driver for the TCS34725 digital color sensors.
	Adapted to allow setting manual delay in arduino code. 
    ...
    v1.0 - First release: Adafruit_TCS34725
	v1.1 - Adapted to quickswitch
*/
/**************************************************************************/
